<template>
    ...
    <v-app-bar-title><h2>Foodie</h2></v-app-bar-title>
    <v-spacer></v-spacer>
    ...
    <v-spacer></v-spacer>
    <div>
        <span class="ml-4 text-caption">My Favorite</span><br />
    ...
    <div>
        ...
        <v-btn append-icon="mdi mdi-lock-open-outline" class="account">My account
            <template v-slot:append>
                <v-icon></v-icon>
            </template>
        </v-btn>
